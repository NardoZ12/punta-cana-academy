-- ============================================================
-- FIX: assignment_type es un ENUM, debe ser TEXT
-- Ejecutar en Supabase SQL Editor
-- ============================================================

-- Paso 1: Cambiar la columna assignment_type de ENUM a TEXT
ALTER TABLE public.assignments 
  ALTER COLUMN assignment_type TYPE TEXT 
  USING assignment_type::TEXT;

-- Paso 2: Establecer default como TEXT simple
ALTER TABLE public.assignments 
  ALTER COLUMN assignment_type SET DEFAULT 'file_upload';

-- Paso 3: Eliminar el tipo ENUM si existe (ya no se necesita)
-- Primero verificar que no hay otras columnas usándolo
DO $$ BEGIN
  DROP TYPE IF EXISTS public.assignment_type CASCADE;
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'No se pudo eliminar el tipo enum, puede estar en uso en otra parte';
END $$;

-- Paso 4: Recrear la función RPC con el tipo correcto
