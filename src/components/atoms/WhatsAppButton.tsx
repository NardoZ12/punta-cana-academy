...
export const WhatsAppButton = ({ 
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      ...
      <div className={`absolute bottom-20 right-0 bg-white text-gray-800 p-4 rounded-lg shadow-xl max-w-xs transition-all duration-500 ${
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600 mt-1">¡Escríbenos por WhatsApp!</p>
          </div>
          <button 
      ...
      <button
        ...
        className="group relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl hover:shadow-green-500/50 transition-all duration-300 transform hover:scale-110 animate-pulse hover:animate-none"
